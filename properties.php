...
<body>
    ...
    <div id="properties">
        ...
        <div id="middle">
            <ul><li>
                <a href="detailed1.php">
                    <div id="img1"></div>
                </a>
            </li></ul>
            <ul><li>
                <a href="detailed2.php">
                    <div id="img2"></div>
                </a>
            </li></ul>
            <ul><li>
                <a href="detailed3.php">
                    <div id="img3"></div>
                </a>
            </li></ul>
        ...
        <div id="imgall">
            ...
            <ul><li>
                <a href="detailed4.php">
                    <div id="img4"> </div>
                </a>
            </li></ul>
            <ul><li>
                <a href="detailed5.php">
                    <div id="img5"></div>
                </a>
            </li></ul>
            <ul><li>
                <a href="detailed6.php">
                    <div id="img6"></div>
                </a>
            </li></ul>
        ...
        <div id="imgall2">
            <ul><li><a href="detailed7.php"><div id="img7"></div></a></li></ul>
            <ul><li><a href="detailed8.php"><div id="img8"></div></a></li></ul>
            <ul><li><a href="detailed9.php"><div id="img9"></div></a></li></ul>
        ...
        <div id="imgall3">
            <ul><li><a href="detailed10.php"><div id="img10"></div></a></li></ul>
            <ul><li><a href="detailed11.php"><div id="img11"></div></a></li></ul>
            <ul><li><a href="detailed12.php"><div id="img12"></div></a></li></ul>
            <div id="price">
                <div id="price1">
                    <span id="pricespan">KSh 39 500 000</span><br><h4 id="h4">Location: Nakuru Town <br>Three Bedroom, Parking & Garden Avaiilable</h4>
                </div>
