...
<body>
    ...
    <div id="properties">
        ...
        <div id="middle">
            ...
            <div id="price">
                <div id="price1">
                    <span id="pricespan">KSh 8.2m</span><br><h4 id="h4">Location: kajiado Town<br>Three Bedroom, Parking & Garden Avaiilable</h4>
                </div>
                <div id="price1">
                    <span id="pricespan">KSh 2.1m</span><br><h4 id="h4">Location: kajiado Town<br>Three Bedroom, Parking & Garden Avaiilable</h4>
                </div>
                <div id="price3">
                    <span id="pricespan">KSh 1.67m</span><br><h4 id="h4">Location: kajiado Town<br>Three Bedroom, Parking & Garden Avaiilable</h4>
                </div>
            </div>
        </div>
        <div id="imgall">
            ...
            <div id="price">
                <div id="price1">
                    <span id="pricespan">KSh 39 500 000</span> <br><h4 id="h4">Location: kajiado Town<br>Three Bedroom, Parking & Garden Avaiilable</h4>
                </div>
                <div id="price1">
                    <span id="pricespan">KSh 39 500 000</span><br><h4 id="h4">Location: kajiado Town<br>Three Bedroom, Parking & Garden Avaiilable</h4>
                </div>
        ...
        <div id="imgall2">
            <ul><li><a href="image7.php"><div id="img7"></div></a></li></ul>
            <ul><li><a href="image8.php"><div id="img8"></div></a></li></ul>
            <ul><li><a href="image9.php"><div id="img9"></div></a></li></ul>
        ...
        <div id="imgall3">
            <ul><li><a href="image10.php"><div id="img10"></div></a></li></ul>
            <ul><li><a href="image11.php"><div id="img11"></div></a></li></ul>
            <ul><li><a href="image12.php"><div id="img12"></div></a></li></ul>
            <div id="price">
                <div id="price1">
                    <span id="pricespan">KSh 39 500 000</span><br><h4 id="h4">Location: kajiado Town <br>Three Bedroom, Parking & Garden Avaiilable</h4>
                </div>
                ...
                <div id="price3">
                    <span id="pricespan">KSh 39 500 000</span><br><h4 id="h4">Location: Nakuru Town <br>Three Bedroom, Parking & Garden Avaiilable</h4>
                </div>
            </div>
        </div>
    </div>
   <div id="properties">
    ...
    <div class="footer">
        ...
        <div id="subfooter2">
             ...
             <ul>
                    <li><a href="properties.php">Nairobi</a></li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <li><a href="properties.php">Nakuru</a></li>
                    <br>
                    <li><a href="properties.php">Naivasha</a></li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <li><a href="properties.php">Laikipia</a></li>
                    <br>
                    <li><a href="properties.php">Eldoret</a></li>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                    <li><a href="properties.php">kajiando</a></li><br>
                    <li><a href="properties.php">Kiambu</a></li><br>
                    <li><a href="properties.php">Thika</a></li><br>
                    <li><a href="properties.php">Kericho</a></li><br>
                </ul>
        </div>
