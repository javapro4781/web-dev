...
<body>
    ...
    <div id="properties">
        ...
        <div id="middle">
            ...
            <div id="price">
                <div id="price1">
                    <span id="pricespan">KSh 8.2m</span><br><h4 id="h4">Location: Nairobi Town<br>Three Bedroom, Parking & Garden Avaiilable</h4>
                </div>
                <div id="price1">
                    <span id="pricespan">KSh 2.1m</span><br><h4 id="h4">Location: Nairobi Town<br>Three Bedroom, Parking & Garden Avaiilable</h4>
                </div>
                <div id="price3">
                    <span id="pricespan">KSh 1.67m</span><br><h4 id="h4">Location: Nairobi Town<br>Three Bedroom, Parking & Garden Avaiilable</h4>
                </div>
            </div>
        </div>
        <div id="imgall">
            ...
            <div id="price">
                <div id="price1">
                    <span id="pricespan">KSh 39 500 000</span> <br><h4 id="h4">Location:Nairobi Town<br>Three Bedroom, Parking & Garden Avaiilable</h4>
                </div>
                <div id="price1">
                    <span id="pricespan">KSh 39 500 000</span><br><h4 id="h4">Location: Nairobi Town<br>Three Bedroom, Parking & Garden Avaiilable</h4>
                </div>
